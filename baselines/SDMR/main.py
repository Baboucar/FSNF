...
parser.add_argument('--dataset', default='/home/user/Music/HSFR/baselines/SDMR/data/ml1m/ml-1m', help='Dataset name', type=str)

parser.add_argument('--epochs', default=20, help='Number of epochs to run', type=int)
