...
if __name__ == "__main__":
    ...
    for epoch in range(args.epochs):
        ...
        best_vloss = vloss
        writer.add_scalar("ml-1mRMSE@GMF-2", HR, epoch)
        writer.add_scalar("ml1mRMSENDCCG@GMF-2", NDCG, epoch)
        writer.add_scalar("ml1-mrmsevloss@GMF-2", best_vloss, epoch)
        writer.add_scalar("ml-1mRMSEtloss@GMF-2", best_tloss, epoch)
