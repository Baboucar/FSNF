...
parser.add_argument("--data_path", type=str, default="/home/user/Documents/bkup/ncf-test/data")
parser.add_argument("--model_path", type=str, default="/home/user/Documents/bkup/ncf-test/model")
